...
SAVE_MODEL_PATH = "models/model_highres.pth"

# Training Hyperparameters
IMG_SIZE = (1024, 1024)  # High Resolution
BATCH_SIZE = 2           # Reduced batch size to fit in VRAM
...
def train():
    ...
    # Lower num_workers to save system RAM if VRAM is tight
    ...
    for epoch in range(EPOCHS):
        ...
        for i, (images, masks) in enumerate(train_loader):
            ...
            if i % 20 == 0: # Print less often due to smaller batches
